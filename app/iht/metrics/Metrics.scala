...
class IhtMetricsImpl @Inject()(protected val metrics: Metrics) extends IhtMetrics
trait IhtMetrics {
  protected val metrics: Metrics
  val registry: MetricRegistry = metrics.defaultRegistry

  val kickOutCounters: Map[KickOutSource.Value, Counter] = Map(
  ...
  val statsCounter: Map[StatsSource.Value, Counter] = Map(
