...
@Singleton
class PDFController @Inject()(val xmlFoToPDF: XmlFoToPDF, val messagesApi: MessagesApi, val pdfFormatter: PdfFormatter, val ihtProperties: IhtProperties) extends ApplicationController with IhtActions with I18nSupport {
