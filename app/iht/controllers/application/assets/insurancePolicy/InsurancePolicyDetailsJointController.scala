...
class InsurancePolicyDetailsJointControllerImpl @Inject()(val metrics: IhtMetrics,
                                                          ...
                                                          val insurancePolicyDetailsJointView: insurance_policy_details_joint,
...
trait InsurancePolicyDetailsJointController extends EstateController {
  ...
  def onPageLoad = authorisedForIhtWithRetrievals(ninoRetrieval) { userNino =>
    implicit request => {
      estateElementOnPageLoad[InsurancePolicy](insurancePolicyJointQuestionForm, insurancePolicyDetailsJointView.apply,
  ...
  def onSubmit = authorisedForIhtWithRetrievals(ninoRetrieval) { userNino =>
    implicit request => {
      ...
      estateElementOnSubmit[InsurancePolicy](
        ...
        insurancePolicyDetailsJointView.apply,
