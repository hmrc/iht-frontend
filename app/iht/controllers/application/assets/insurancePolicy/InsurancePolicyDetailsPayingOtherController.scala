...
class InsurancePolicyDetailsPayingOtherControllerImpl @Inject()(val metrics: IhtMetrics,
                                                                ...
                                                                val insurancePolicyDetailsPayingOtherView: insurance_policy_details_paying_other,
...
trait InsurancePolicyDetailsPayingOtherController extends EstateController {
  ...
  def onPageLoad = authorisedForIhtWithRetrievals(ninoRetrieval) { userNino =>
    implicit request =>
      estateElementOnPageLoad[InsurancePolicy](insurancePolicyPayingOtherForm, insurancePolicyDetailsPayingOtherView.apply,
  ...
  def onSubmit = authorisedForIhtWithRetrievals(ninoRetrieval) { userNino =>
    implicit request => {
      ...
      estateElementOnSubmitConditionalRedirect[InsurancePolicy](
        ...
        insurancePolicyDetailsPayingOtherView.apply,
