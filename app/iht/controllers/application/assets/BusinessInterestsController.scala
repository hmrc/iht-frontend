...
class BusinessInterestsControllerImpl @Inject()(val metrics: IhtMetrics,
                                                ...
                                                val businessInterestsView: business_interests,
...
trait BusinessInterestsController extends EstateController {
  ...
  def onPageLoad = authorisedForIhtWithRetrievals(ninoRetrieval) { userNino =>
    implicit request =>
      estateElementOnPageLoad[BasicEstateElement](businessInterestForm, businessInterestsView.apply, _.allAssets.flatMap(_.businessInterest), userNino)
  }
