...
@Singleton
class GiftsWithReservationOfBenefitController @Inject() (implicit val messagesApi: MessagesApi, val ihtProperties: IhtProperties) extends EstateController {
            ...
            applicationDetails match {
              case Some(appDetails) => {
                ...
                Ok(iht.views.html.application.tnrb.gifts_with_reservation_of_benefit(
                  ...
                  tnrbModel,
                  deceasedName,
                  CommonHelper.addFragmentIdentifier(cancelUrl, Some(ihtProperties.TnrbGiftsWithReservationID))
                ))
              }
    ...
    for {
      ...
      savedApplicationDetails.fold[Result] {
        ...
        updatedAppDetailsWithKickOutReason.kickoutReason match {
          ...
          case _ => TnrbHelper.successfulTnrbRedirect(updatedAppDetailsWithKickOutReason, Some(ihtProperties.TnrbGiftsWithReservationID))
        }
      }
    }
  }
