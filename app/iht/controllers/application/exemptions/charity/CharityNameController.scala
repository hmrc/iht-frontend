...
class CharityNameController @Inject()(
  ...
  def editSubmitUrl(id: String) = CommonHelper.addFragmentIdentifier(routes.CharityNameController.onEditSubmit(id), Some(ihtProperties.ExemptionsCharitiesNameID))
