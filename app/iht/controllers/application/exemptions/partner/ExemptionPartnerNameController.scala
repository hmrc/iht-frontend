...
import iht.utils.{ApplicationKickOutCommonHelper, ApplicationKickOutHelper, StringHelper}
    ...
    withApplicationDetails {
      rd =>
        appDetails =>
          ...
          val applicationDetails = ApplicationKickOutCommonHelper.updateKickout(
            checks = ApplicationKickOutCommonHelper.checksEstate,
