...
class StocksAndSharesListedViewTest extends ShareableElementInputViewBehaviour[StockAndShare] {
  ...
  override def pageTitle = Messages("iht.estateReport.assets.stocksAndSharesListed")
  override def browserTitle = Messages("page.iht.application.assets.stocksAndShares.listed.browserTitle")

  override def questionTitle = Messages("iht.estateReport.assets.stocksAndShares.listed.question", deceasedName)
  override def valueQuestion = Messages("iht.estateReport.assets.stocksAndShares.valueOfListed")
