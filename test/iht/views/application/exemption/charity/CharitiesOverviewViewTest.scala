...
class CharitiesOverviewViewTest extends ViewTestHelper {
  ...
  "CharitiesOverview view" must {
    ...
    "have correct title and browser title " in {
      ...
      titleShouldBeCorrect(view, Messages("iht.estateReport.exemptions.charities.assetsLeftToCharities.title"))
      browserTitleShouldBeCorrect(view, Messages("iht.estateReport.exemptions.charities.assetsLeftToCharities.title"))
    }
