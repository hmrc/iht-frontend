    ...
    <xsl:template name="pre-exemptions">
        ...
        <xsl:if test="allExemptions/partner">
            <fo:block font-family="OpenSans" font-size="16pt" font-weight="regular" space-before="0.5cm"
                ...
                <xsl:value-of select="i18n:getMessagesText($translator, 'iht.estateReport.exemptions.partner.assetsLeftToSpouse.title')"/>
            </fo:block>
                ...
                <fo:table space-before="0.5cm">
                    ...
                    <fo:table-body font-size="12pt">
                        ...
                        <xsl:if test="allExemptions/partner/isAssetForDeceasedPartner='true'">
                            <xsl:call-template name="table-row-short-vpad">
                                <xsl:with-param name="label"
                                                select="i18n:getMessagesText($translator, 'iht.estateReport.exemptions.partner.homeInUK.question')"/>
                                <xsl:with-param name="value">
                            ...
                            <xsl:call-template name="table-row-short-vpad">
                                <xsl:with-param name="label"
                                                select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.overview.partner.name.title')"/>
                                <xsl:with-param name="value"
                                                select="concat(allExemptions/partner/firstName,' ', allExemptions/partner/lastName)"/>
                            </xsl:call-template>
                            <xsl:call-template name="table-row-short-vpad">
                                <xsl:with-param name="label"
                                                select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.overview.partner.dob.title')"/>
                                <xsl:with-param name="value"
                                                select="formatter:getDateForDisplay($pdfFormatter, allExemptions/partner/dateOfBirth)"/>
                            </xsl:call-template>
                            <xsl:call-template name="table-row-short-vpad">
                                <xsl:with-param name="label"
                                                select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.overview.partner.nino.title')"/>
                                <xsl:with-param name="value"
        ...
        <fo:block font-family="OpenSans" font-size="16pt" font-weight="regular" space-before="0.5cm" page-break-inside="avoid">
            <xsl:value-of select="i18n:getMessagesText($translator, 'iht.estateReport.exemptions.charities.assetsLeftToCharities.title')"/>
            <xsl:choose>
                    ...
                    <fo:block font-family="OpenSans" font-size="12pt">
                        <fo:table space-before="0.5cm">
                            ...
                            <fo:table-body font-size="12pt">
                                <xsl:call-template name="table-row-short-vpad">
                                    <xsl:with-param name="label"
                                                    select="i18n:getMessagesTextWithParameter($translator, 'iht.estateReport.exemptions.charities.assetLeftToCharity.question', $deceasedName)"/>
                                    <xsl:with-param name="value">
                                        <xsl:choose>
                        ...
                        <fo:block font-family="OpenSans" font-size="16pt" font-weight="regular" space-before="0.5cm">
                            <xsl:value-of select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.charityOverviewTable.header')"/>
                                ...
                                <fo:table space-before="0.5cm">
                                    ...
                                    <fo:table-body font-size="12pt">
                                        <xsl:for-each select="charities">
                                            <xsl:call-template name="table-row-short-vpad">
                                                <xsl:with-param name="label" select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.charityName.sectionTitle')"/>
                            ...
                            <xsl:if test="not(charities)">
                                <fo:block font-family="OpenSans" font-weight="regular" font-size="12pt" space-before="0.5cm">
                                    <xsl:value-of select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.charityOverview.noCharities.text')"/>
                                </fo:block>
                            </xsl:if>
                        </fo:block>
                    </fo:block>
        ...
        <fo:block font-family="OpenSans" font-size="16pt" font-weight="regular" space-before="0.5cm" page-break-inside="avoid">
            <xsl:value-of select="i18n:getMessagesText($translator, 'iht.estateReport.exemptions.qualifyingBodies.assetsLeftToQualifyingBodies.title')"/>
            <xsl:choose>
                    ...
                    <fo:block font-family="OpenSans" font-size="12pt">
                        <fo:table space-before="0.5cm">
                            ...
                            <fo:table-body font-size="12pt">
                                <xsl:call-template name="table-row-short-vpad">
                                    <xsl:with-param name="label"
                                                    select="i18n:getMessagesTextWithParameter($translator, 'page.iht.application.exemptions.qualifyingBodyOverview.question', $deceasedName)"/>
                                    <xsl:with-param name="value">
                                        <xsl:choose>
                        ...
                        <fo:block font-family="OpenSans" font-size="16pt" font-weight="regular" space-before="0.5cm">
                            <xsl:value-of select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.qualifyingBodyOverviewTable.header')"/>
                            ...
                            <xsl:if test="not(qualifyingBodies)">
                                <fo:block font-family="OpenSans" font-weight="regular" font-size="12pt" space-before="0.5cm">
                                    <xsl:value-of select="i18n:getMessagesText($translator, 'page.iht.application.exemptions.qualifyingBodyOverview.noQualifyingBodies.text')"/>
                                </fo:block>
                            </xsl:if>
                        </fo:block>
                    </fo:block>
